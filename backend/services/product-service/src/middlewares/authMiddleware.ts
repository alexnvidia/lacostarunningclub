...
/**
 * Authentication middleware: verify the JWT and extract the user.
 * It is applied before the routes that require authentication.
 */
...
/**
 * Authorization middleware: verify that the authenticated user is ADMIN.
